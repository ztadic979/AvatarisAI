...
export default function InvestorsPage() {
  return (
    <div className="min-h-screen bg-[#03090E] overflow-x-hidden">
      ...
      <section className="relative min-h-[1200px] flex flex-col justify-center items-center px-4 text-center overflow-hidden z-20">
        ...
        <div className="flex space-x-4 z-10 mb-16">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-32 text-center  mt-32 md:mb-20 z-0">
          {[
      ...
      <section className="relative py-12 px-4 lg:px-8 overflow-hidden z-0">
        ...
        <div className="max-w-6xl mx-auto text-white relative">
          ...
          <div className="space-y-12">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="ttext-white font-normal  leading-relaxed">
